...
@DockerCompose(composeFile = "resource:/docker-compose-uptime.yml", exposedServicePorts =
        [
                @Expose(service = "whoami", port = 80)
        ], shared = true)
@Stepwise
class DockerComposeSpecSharedAnnotationWithResourceIT extends Specification {
